public class AccountTest {
    public static void main(String[] args) {
        ...
        myAccount.deposit(1000.0); // updates balance + prints account

        myAccount.withdraw(100.0); // updates balance + prints account
        ...
        myAccount.withdraw(500.0); // Not allowed + prints account

        myAccount.deposit(1000.0); // Not allowed + prints account
    }
}
